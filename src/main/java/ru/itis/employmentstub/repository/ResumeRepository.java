...
public interface ResumeRepository extends JpaRepository<Resume, Long> {
    @Query(value = "select r.id,r.birthday,r.citizenship,r.email,r.firstname,r.lastname,r.middlename,r.phone_number,r.sex,r.resume_file_id from resume r where r.id=:id", nativeQuery = true)
